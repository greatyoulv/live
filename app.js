...
var ipcRouter = require('./routes/ipc');
var addipcRouter = require('./routes/addipc');
var delipcRouter = require('./routes/delipc');
...
app.use('/addipc', addipcRouter);
app.use('/delipc', delipcRouter);
